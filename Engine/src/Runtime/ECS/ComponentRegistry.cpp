...
namespace Alice
{
    ...
    RTTR_REGISTRATION
    {
        ...
        rttr::registration::class_<MaterialComponent>("MaterialComponent")
            ...
            .property("emissiveColor", &MaterialComponent::emissiveColor)
            .property("emissiveIntensity", &MaterialComponent::emissiveIntensity)
            .property("emissiveBloom", &MaterialComponent::emissiveBloom)
            ...
            .property("emissiveTexturePath", &MaterialComponent::emissiveTexturePath)
       ...
       // Transform�� TransformComponent���� ����ϹǷ� ���⼱ ����
        ...
        rttr::registration::class_<PostProcessSettings>("PostProcessSettings")
            ...
            .property("bOverride_EmissiveBloomIntensity", &PostProcessSettings::bOverride_EmissiveBloomIntensity)
            .property("emissiveBloomIntensity", &PostProcessSettings::emissiveBloomIntensity)
        ...
        rttr::registration::class_<ComputeEffectComponent>("ComputeEffectComponent")
            ...
            .property("emitNewParticles", &ComputeEffectComponent::emitNewParticles)
            .property("loop", &ComputeEffectComponent::loop)
            .property("emissionDurationSec", &ComputeEffectComponent::emissionDurationSec)
